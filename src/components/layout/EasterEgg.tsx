...
export default function EasterEgg() {
    useEffect(() => {
        ...
        // Title only changes after user presses F12 / Ctrl+Shift+I
        ...
        // Also unlock title if viewport shrinks (right-click > Inspect)
        ...
        // Main animation - runs immediately (invisible when console is closed)
        const mainInterval = setInterval(() => {
            ...
            // Tab title only changes if user has opened DevTools
            if (titleUnlocked) {
